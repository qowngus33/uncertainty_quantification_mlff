...
def evaluate(model, likelihood, file_path, device):
    ...
    # test_x = positions.view(batch_size, -1).to(device)
...
def train(alpha, file_path, model_name, device):
    ...
    # train_x = positions.view(batch_size, -1).to(device) # position vector only
...
if __name__ == "__main__":
    ...
    file_path = "/home/jhbae/Project/uncertainty/"
    model_name = f"gpr_PeriodicKernel_lr_0.1_patience_1000_use_ionization."
